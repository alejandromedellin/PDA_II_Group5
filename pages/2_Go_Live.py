...
# Check if the selected date is a weekend (Saturday=5, Sunday=6)
if prediction_date.weekday() in (5, 6):
    st.warning(
        "You have selected a weekend date. The markets are closed on weekends, "
        "so there may be no trading data available."
    )
